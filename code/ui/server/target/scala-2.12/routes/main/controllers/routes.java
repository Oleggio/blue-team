...
public class routes {
  ...
  public static final controllers.ReverseHotelsController HotelsController = new controllers.ReverseHotelsController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseHotelsController HotelsController = new controllers.javascript.ReverseHotelsController(RoutesPrefix.byNamePrefix());
